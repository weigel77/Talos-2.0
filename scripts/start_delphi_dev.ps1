...
try {
    ...
    $env:APP_PORT = '5015'
    $env:APP_DISPLAY_NAME = 'Talos 3.10'
    $env:APP_PAGE_KICKER = 'TALOS 3.10'
    $env:APP_VERSION_LABEL = 'TALOS 3.10'
    ...
    Write-Host 'Talos 3.10 local startup | runtime=hosted-development | url=https://127.0.0.1:5015/hosted'
    & $pythonExe app.py
}
finally {
    Pop-Location
